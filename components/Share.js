...
function Share(props) {
    return(
        <div className="pt-1">
                ...
                <img style={{color:'#3b5998', width:'1.2rem'}} src={`/facebook.svg`}/>
                </a>
                ...
                <img style={{color:'#3b5998', width:'1.2rem'}} src={`/twitter.svg`}/>
                </a>
                ...
                <img style={{color:'#3b5998', width:'1.2rem'}} src={`/linkedin.svg`}/>
                </a>
                <a target="_blank" href={`whatsapp://send?text=${Package.homepage}${props.url}`} className="mr-2">
                <img style={{color:'#3b5998', width:'1.2rem'}} src={`/whatsapp.svg`}/>
                </a>
            </div>
    )
}
